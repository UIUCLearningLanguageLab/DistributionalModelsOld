from distributionalmodels.tasks.task import Task
import numpy as np
import pandas as pd
import time as time
...
class CohyponymTask(Task):
    ...
    def compute_ba(self, exclude_identity_pairs=False, exclude_symmetric_pairs=False):
