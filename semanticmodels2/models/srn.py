...
from semanticmodels2.params import RNNParams, Params
...
class SRN:
    ...
    def calc_pp(self, numeric_document_list: List[List[int]]):
        ...
        for document in numeric_document_list:
            for i in range(len(document[:-1])):
                ...
                h, z_o, o, o_prob, loss = self.test_item(input_vector, old_h, label_vector, self.optimizer)
                old_h = h.detach()
    ...
    def test_item(self, x, old_h, y, torch_optimizer):
        z_h, h, z_o, o, o_prob = self.model.forward_item(x, old_h)
